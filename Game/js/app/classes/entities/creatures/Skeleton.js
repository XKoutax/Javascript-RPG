...
define(['Creature','Assets','HealthBar','ManaPotion'],function(Creature,Assets,HealthBar,ManaPotion){
        ...
        takeDamage:function(_damage){
            ...
            var randomSpawn=Math.ceil(Math.random()*100);
                if(randomSpawn>50&&this.spawnedItem==0) {
                    this.handler.getWorld().getEntityManager().addEntity(new ManaPotion(this.handler, this.x , this.y));
                    this.spawnedItem=1;
                }
            }
        }
