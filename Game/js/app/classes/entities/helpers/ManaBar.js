define(['Helper'],function(Helper){
    ...
    var ManaBar = Helper.extend({
        ...
        render:function(_g){
            ...
            if(this.renderOnFull=="on"||this.ent.mana<this.start){
...
//creez borderul healthbarului
        ...
        update:function(){
            ...
            this.opacity = 1;
            this.nodes=Math.ceil(this.totalnodes*(this.ent.mana/this.start)); //nr nodes = nr nodes * cat hp are acu / cat hp avea

        }
    });
//statice:
    ManaBar.DEFAULT_NODES=10;
    ManaBar.DEFAULT_Y_OFFSET=10;
    ManaBar.DEFAULT_X_OFFSET=0;
    return ManaBar;
});